...
namespace WhoIsBigger
{
    public partial class GameForm : Form
    {
        ...
        private void InitTable()
        {
            ...
            {
                this.ScoreTable.Rows.Add(player.Name, 0);
            }
        }
        ...
        private void StartRoundButton_Click(object sender, EventArgs e)
        {
            try
            {
                GameSession.StartRound();
                RoundStatusLabel.Text = GameSession.isRoundStarted ? "Раунд запущен" : "Раунд не начат";
                RoundNumberLabel.Text = string.Format("{0} раунд", GameSession.CurrentRound.RoundNumber);
            }
            catch (Exception ex)
            {
        ...
        private void MakeRollButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                UpdateTable();
                RoundStatusLabel.Text = "Раунд окончен";
